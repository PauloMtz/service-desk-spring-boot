...
@Component
public class CriaUsuarioAtend implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (usuario == null) {
            usuario = new Usuario();
            usuario.setEmail("atend@mail.com");
            usuario.setNome("Ribamar de Sousa e Silva");
            usuario.setEmail(email);
            usuario.setAtivo(true);
            // cria perfil
            Perfil perfil = perfilRepository.findByPerfil("ATEND");
